...
const msql_s = $GLOBALS["___mysqli_ston"];	

if( !@ msql_s= mysqli_connect( $_DVWA[ 'db_server' ],  $_DVWA[ 'db_user' ],  $_DVWA[ 'db_password' ], "", $_DVWA[ 'db_port' ] )) ) {
...
if( !@mysqli_query(msql_s,  $drop_db ) ) {
	dvwaMessagePush( "Could not drop existing database<br />SQL: " . ((is_object(msql_s)) ? mysqli_error($GLOBALS["___mysqli_ston"]) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)) );
	dvwaPageReload();
}

$create_db = "CREATE DATABASE {$_DVWA[ 'db_database' ]};";
if( !@mysqli_query(msql_s,  $create_db ) ) {
	dvwaMessagePush( "Could not create database<br />SQL: " . ((is_object(msql_s)) ? mysqli_error(msql_s) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)) );
	dvwaPageReload();
}
...
// Create table 'users'
if( !@((bool)mysqli_query(msql_s, "USE " . $_DVWA[ 'db_database' ])) ) {
...
if( !mysqli_query(msql_s,  $create_tb ) ) {
	dvwaMessagePush( "Table could not be created<br />SQL: " . ((is_object(msql_s)) ? mysqli_error(msql_s) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)) );
	dvwaPageReload();
}
...
if( !mysqli_query($GLOBALS["___mysqli_ston"],  $insert ) ) {
	dvwaMessagePush( "Data could not be inserted into 'users' table<br />SQL: " . ((is_object(msql_s)) ? mysqli_error(msql_s) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)) );
	dvwaPageReload();
}
...
if( !mysqli_query(msql_s,  $create_tb_guestbook ) ) {
	dvwaMessagePush( "Table could not be created<br />SQL: " . ((is_object(msql_s)) ? mysqli_error(msql_s) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)) );
	dvwaPageReload();
}
...
if( !mysqli_query(msql_s,  $insert ) ) {
	dvwaMessagePush( "Data could not be inserted into 'guestbook' table<br />SQL: " . ((is_object(msql_s)) ? mysqli_error(msql_s) : (($___mysqli_res = mysqli_connect_error()) ? $___mysqli_res : false)) );
	dvwaPageReload();
}
